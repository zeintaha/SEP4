...
namespace Leap.Unity.Interaction {
  ...
  public class AnchorableBehaviour : MonoBehaviour {
    ...
    void Update() {
      ...
      if (gameObject.name == "Anchorable Object (Magenta)1")
      {
          HandsUp.Magenta1 = isAttached;
      }
      else if(gameObject.name == "Anchorable Object (Magenta)2")
      {
          HandsUp.Magenta2 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Magenta)3")
      {
          HandsUp.Magenta3 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Magenta)4")
      {
          HandsUp.Magenta4 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Red)1")
      {
          HandsUp.Red1 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Red)2")
      {
          HandsUp.Red2 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Red)3")
      {
          HandsUp.Red3 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Red)4")
      {
          HandsUp.Red4 = isAttached;
      }
            else if (gameObject.name == "Anchorable Object (Blue)1")
      {
          HandsUp.Blue1 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Blue)2")
      {
          HandsUp.Blue2 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Blue)3")
      {
          HandsUp.Blue3 = isAttached;
      }
      else if (gameObject.name == "Anchorable Object (Blue)4")
      {
          HandsUp.Blue4 = isAttached;
      }
            else if (gameObject.name == "Anchorable Object (Green)")
      {
          HandsUp.Green = isAttached;
      }
